...
if __name__ == '__main__':
  if not len(sys.argv) == 3:
    ...
    for line in vfile:
        ...
        draw.rectangle(((int(vdata[6]), int(vdata[7])), (int(vdata[6])+int(vdata[8]), int(vdata[7])+int(vdata[9]))), fill=None)
        ...
        source_img.save(video_path_frames + '/' + video_name + '_frame-' + vdata[5] + '.jpg', "JPEG")
